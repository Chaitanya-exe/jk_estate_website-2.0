...
export default function Hero() {
  return (
    <section className="relative min-h-[760px] overflow-hidden bg-[#092a28] sm:min-h-[850px]">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[#062d2a]/65" />

        <div className="absolute inset-0 bg-gradient-to-r from-[#062a28] via-[#062a28]/55 to-transparent" />

        <div className="absolute inset-0 bg-gradient-to-t from-[#062a28] via-transparent to-[#062a28]/25" />
      </div>
        ...
        <div className="grid w-full items-end gap-12 lg:grid-cols-[1fr_390px]">
          <div className="max-w-4xl">
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-[0.68rem] font-bold uppercase tracking-[0.2em] text-white/75 backdrop-blur-md">
              <span className="h-1.5 w-1.5 rounded-full bg-[#72d7cb]" />
            ...
            <h1 className="font-display text-[clamp(3.7rem,8vw,7.8rem)] font-medium leading-[0.9] tracking-[-0.055em] text-white">
              Find the space
              <span className="block text-[#72d7cb]">behind your next move.</span>
            </h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#contact"
                className="button border border-white/25 bg-white/10 text-white backdrop-blur-md hover:bg-white/15"
              >
                Book a consultation
                <span aria-hidden="true">↗</span>
              </a>
          ...
          <div className="glass-strong rounded-[28px] p-6 sm:p-7">
            <div className="flex items-center justify-between border-b border-[#134E4A]/10 pb-5">
              <span className="text-[0.65rem] font-bold uppercase tracking-[0.18em] text-[#647875]">
                Current focus
              </span>

              <span className="rounded-full bg-[#e8f7f4] px-3 py-1 text-[0.62rem] font-bold uppercase tracking-wider text-[#0F766E]">
                2026
              </span>
            </div>

            <div className="py-6">
              <p className="font-display text-3xl leading-tight tracking-[-0.03em] text-[#134E4A]">
                Spaces built around how modern businesses actually work.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-2xl bg-[#134E4A] p-4 text-white">
              ...
              <div className="rounded-2xl bg-white/70 p-4">
                <strong className="font-display text-2xl font-medium text-[#134E4A]">
                  98%
                </strong>
                <span className="mt-1 block text-[0.63rem] uppercase tracking-wider text-[#647875]">
                  Success rate
                </span>
              </div>
            </div>
